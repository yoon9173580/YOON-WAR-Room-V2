 ...
 * access falls back to DEFAULT_ALLOWED_EMAILS (never to "everyone") -
 * set ALLOWED_EMAILS in Vercel to add more accounts without a code change.
 *
...
// Used only when ALLOWED_EMAILS isn't set in the environment.
const DEFAULT_ALLOWED_EMAILS = ['yoongun64@gmail.com'];
...
function isEmailAllowed(email) {
  ...
  if (allowed.length === 0) return false; // defensive: getAllowedEmails never actually returns empty
